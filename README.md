...
User flow state transistion diagram for reference (\[\] square brackets denote fragment / activity name). Each square denotes a an ativiy, each circles denote a fragement within our app.
